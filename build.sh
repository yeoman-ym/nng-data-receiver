...
echo -e "\n选项说明:"
echo -e "  ${BLUE}-n, --no-log-file${NC}  禁用本地日志文件（只输出到终端，提升性能）"
echo -e "  ${BLUE}-h, --help${NC}         显示帮助信息"
echo -e "\n禁用日志文件示例（推荐用于高性能场景）:"
echo -e "  ${BLUE}./bin/user_sim_screen --no-log-file 11112${NC}"
echo -e "  ${BLUE}./bin/user_sim_screen -n 127.0.0.1 11112${NC}"
